# Installing CrystalScopeX 0.3.7 on macOS
...
2. Download `CrystalScopeX-0.3.7-macOS-arm64.dmg` only from the official
...
CrystalScopeX 0.3.7 is ad-hoc code-signed and has not been notarized by Apple.
